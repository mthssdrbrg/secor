...
public class MessagePackParserTest extends TestCase {
    ...
    public void setUp() throws Exception {
        ...
        mMessageWithSecondsTimestamp = new Message("test", 0, 0, new byte[0],
        ...
        mMessageWithMillisTimestamp = new Message("test", 0, 0, new byte[0],
        ...
        mMessageWithMillisFloatTimestamp = new Message("test", 0, 0, new byte[0],
        ...
        mMessageWithMillisStringTimestamp = new Message("test", 0, 0, new byte[0],
    ...
    public void testMissingTimestamp() throws Exception {
        ...
        Message nMessageWithoutTimestamp = new Message("test", 0, 0, new byte[0],
    ...
    public void testUnsupportedTimestampFormat() throws Exception {
        ...
        Message nMessageWithUnsupportedFormatTimestamp = new Message("test", 0, 0, new byte[0],
    ...
    public void testNullTimestamp() throws Exception {
        ...
        Message nMessageWithNullTimestamp = new Message("test", 0, 0, new byte[0],
